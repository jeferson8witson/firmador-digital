  ...
  return (
    <div className="flex flex-col items-center justify-center  py-2 overflow-x-hidden">
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1  text-center ">
          ...
          <h1 className="text-6xl font-bold">PARA PODER REALIZAR EL TRAMITE,<br/> PRIMERO DEBE REGISTRARSE</h1>
          <a href="/firma-digital?firma=true" className="px-10 py-2 bg-indigo-800 text-white rounded-3xl my-10 text-4xl">Registrarse</a>
              <a href="/firma-digital?firma=true" className="px-5 py-2 bg-blue-600 text-white rounded-3xl mb-10 text-4xl">Protección de Cuenta</a>
